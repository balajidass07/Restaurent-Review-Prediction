...
#1.Classification model -> GaussenNB model v r using here
...
# Making the Confusion Matrix (cm) -> for checking predicted result and original result
    # correct prediction=[0,0]+[1,1]=55+91
    # incorrect prediction=[0,1]+[1,0]=42+12
...
'''
#2.Classification model -> Decision tree classification
...
# Fitting Dtree  to the Training set
...
# Making the Confusion Matrix (cm) -> for checking predicted result and original result
    # correct prediction=[0,0]+[1,1]=74+68
    # incorrect prediction=[0,1]+[1,0]=23+35
from sklearn.metrics import confusion_matrix
cm=confusion_matrix(Y_test, Y_pred)
'''
...
'''
#3.Classification model -> Random Forest classification
...
# Making the Confusion Matrix (cm) -> for checking predicted result and original result
    # correct prediction=[0,0]+[1,1]=87+57
    # incorrect prediction=[0,1]+[1,0]=46+10
from sklearn.metrics import confusion_matrix
cm=confusion_matrix(Y_test, Y_pred)
'''

'''
#4.Classification model -> KNN classification
...
# Making the Confusion Matrix (cm) -> for checking predicted result and original result
    # correct prediction=[0,0]+[1,1]=74+48
    # incorrect prediction=[0,1]+[1,0]=55+23
from sklearn.metrics import confusion_matrix
cm=confusion_matrix(Y_test, Y_pred)
'''

'''
#5.Classification model -> Kernal SVM classification
...
# Making the Confusion Matrix (cm) -> for checking predicted result and original result
    # correct prediction=[0,0]+[1,1]=90+57
    # incorrect prediction=[0,1]+[1,0]=46+7
from sklearn.metrics import confusion_matrix
cm=confusion_matrix(Y_test, Y_pred)
'''

'''
#6.Classification model -> Logistic Regression classification
...
# Making the Confusion Matrix (cm) -> for checking predicted result and original result
    # correct prediction=[0,0]+[1,1]=76+66
    # incorrect prediction=[0,1]+[1,0]=37+21
from sklearn.metrics import confusion_matrix
cm=confusion_matrix(Y_test, Y_pred)
'''
